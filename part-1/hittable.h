...
class Hittable {
 public:
  ...
  // The linter is going to complain that HitRecrod& rec should be const or be
  // made into a pointer. The right thing to do is to turn it into a pointer.
  // However, in CPSC 120, we have yet to learn about pointers so it is
  // safe to ignore the linter's message.
};
